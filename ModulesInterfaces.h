...
public:
  ...
  virtual void runModule (const ECGWaves &, const ECGSignalChannel &, const ECGInfo &, QRSClass &) = 0;
};
...
public:
  ...
  virtual void runModule (const ECGRs &, const ECGWaves &, const QRSClass &, const ECGInfo &, ECGHRT &) = 0;
};
