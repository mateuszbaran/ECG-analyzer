...
public:
  ...
  virtual void runModule (const ECGWaves &, const ECGSignalChannel &, const ECGInfo &, ECGClasses &) = 0;
};
...
public:
  ...
  virtual void runModule (const ECGWaves &, const ECGSignalChannel &, const ECGInfo &, ECGST &) = 0;
};
